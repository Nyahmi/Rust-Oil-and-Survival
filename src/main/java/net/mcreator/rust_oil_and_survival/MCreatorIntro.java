...
public class MCreatorIntro extends Elementsrust_oil_and_survival.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("rust_oil_and_survival:intro")
	public static final Item block = null;
	public static DimensionType dtype;

	public MCreatorIntro(Elementsrust_oil_and_survival instance) {
		super(instance, 23);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension intro is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("intro", "_intro", DIMID, WorldProviderMod.class, true);
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("rust_oil_and_survival:cinematic")),};
